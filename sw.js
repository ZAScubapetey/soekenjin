  ...
  var e = {
      ...
      194: (e, t, s) => {
        ...
        async function r(e, t) {
          let s = null;
          if ((e.url && (s = new URL(e.url).origin), s !== self.location.origin)) throw new n.V("cross-origin-copy-response", { origin: s });
          const r = e.clone(),
        ...
        class i {
          ...
          handleRequest({ request: e, event: t }) {
            ...
            const a = s.origin === location.origin,
              { params: n, route: r } = this.findMatchingRoute({ event: t, request: e, sameOrigin: a, url: s });
            let i = r && r.handler;
            const c = e.method;
          ...
          unregisterRoute(e) {
            if (!this._routes.has(e.method)) throw new r.V("unregister-route-but-not-found-with-method", { method: e.method });
      ...
      917: (e, t, s) => {
        ...
        function c(e, t, s) {
          ...
          if ("string" == typeof e) {
            ...
            if (!(e instanceof n.A))
              throw new a.V("unsupported-route-type", { moduleName: "workbox-routing", funcName: "registerRoute", paramName: "capture" });
            c = e;
          }
      ...
      951: (e, t, s) => {
        ...
        class i {
          ...
          async _getResponse(e, t, s) {
            ...
            try {
              if (((a = await this._handle(t, e)), !a || "error" === a.type)) throw new n.V("no-response", { url: t.url });
            } catch (n) {
              if (n instanceof Error) for (const r of e.iterateCallbacks("handlerDidError")) if (((a = await r({ error: n, event: s, request: t })), a)) break;
              if (!a) throw n;
            }
            for (const n of e.iterateCallbacks("handlerWillRespond")) a = await n({ event: s, request: t, response: a });
            return a;
          }
          async _awaitComplete(e, t, s, a) {
            ...
            if ((await t.runCallbacks("handlerDidComplete", { event: a, request: s, response: n, error: r }), t.destroy(), r)) throw r;
          }
        }
      },
      333: (e, t, s) => {
        ...
        class l {
          ...
          async fetch(e) {
            ...
            try {
              ...
              if (e instanceof Error) throw new o.V("plugin-error-request-will-fetch", { thrownErrorMessage: e.message });
            }
            const n = s.clone();
            try {
              let e;
              ...
              throw (a && (await this.runCallbacks("fetchDidFail", { error: e, event: t, originalRequest: a.clone(), request: n.clone() })), e);
            }
          }
          ...
          async cacheMatch(e) {
            ...
            for (const e of this.iterateCallbacks("cachedResponseWillBeUsed"))
              s = (await e({ cacheName: a, matchOptions: n, cachedResponse: s, request: r, event: this.event })) || void 0;
            return s;
          }
          async cachePut(e, t) {
            const s = h(e);
            ...
            if (!t) throw new o.V("cache-put-with-no-response", { url: (0, i.C)(n.url) });
            ...
            const { cacheName: u, matchOptions: d } = this._strategy,
              ...
              g = p ? await (0, a.F)(f, n.clone(), ["__WB_REVISION__"], d) : null;
            try {
            ...
            for (const e of this.iterateCallbacks("cacheDidUpdate"))
              await e({ cacheName: u, oldResponse: g, newResponse: l.clone(), request: n, event: this.event });
            return !0;
          }
          async getCacheKey(e, t) {
            ...
            if (!this._cacheKeys[s]) {
              let a = e;
              for (const e of this.iterateCallbacks("cacheKeyWillBeUsed")) a = h(await e({ mode: t, request: a, event: this.event, params: this.params }));
              this._cacheKeys[s] = a;
            }
      ...
      308: (e, t, s) => {
        s.r(t), s.d(t, { CacheableResponse: () => a, CacheableResponsePlugin: () => n }), s(524), s(125), s(119), s(120), s(895);
        class a {
          constructor(e = {}) {
      ...
      634: (e, t, s) => {
        ...
        async function w(e) {
          ...
          for (
            ;
            performance.now() - n < 2e3 && ((t = await self.clients.matchAll({ type: "window" })), (a = t.find((t) => (e ? t.id === e : !s.has(t.id)))), !a);
      ...
      370: (e, t, s) => {
        s.r(t), s.d(t, { CacheExpiration: () => C, ExpirationPlugin: () => N }), s(524);
        var a = s(327),
          n = (s(120), s(125));
        let r, i;
        const c = new WeakMap(),
        ...
        var R;
        (R = d), (d = { ...R, get: (e, t, s) => _(e, t) || R.get(e, t, s), has: (e, t) => !!_(e, t) || R.has(e, t) }), s(550);
        ...
        class x {
          ...
          async setTimestamp(e, t) {
            const s = { url: (e = b(e)), timestamp: t, cacheName: this._cacheName, id: this._getId(e) },
              a = (await this.getDb()).transaction(v, "readwrite", { durability: "relaxed" });
          ...
          async getDb() {
            return (
              this._db ||
                (this._db = await (function (e, t, { blocked: s, upgrade: a, blocking: n, terminated: r } = {}) {
        ...
        class N {
          constructor(e = {}) {
            (this.cachedResponseWillBeUsed = async ({ event: e, request: t, cacheName: s, cachedResponse: n }) => {
              ...
              e.purgeOnQuotaError && (0, k.t)(() => this.deleteCacheAndMetadata());
          }
      ...
      522: (e, t, s) => {
        ...
        var a = s(536),
          ...
          r = s(392);
        function i(e) {
          if (!e) throw new n.V("add-to-cache-list-unexpected-type", { entry: e });
          if ("string" == typeof e) {
            const t = new URL(e, location.href);
            return { cacheKey: t.href, url: t.href };
          }
          const { revision: t, url: s } = e;
          if (!s) throw new n.V("add-to-cache-list-unexpected-type", { entry: e });
          if (!t) {
        ...
        class u extends l._ {
          ...
          async _handleFetch(e, t) {
            let s;
            const a = t.params || {};
            if (!this._fallbackToNetwork) throw new n.V("missing-precache-entry", { cacheName: this.cacheName, url: e.url });
            {
              const n = a.integrity,
                r = e.integrity,
                i = !r || r === n;
          ...
          async _handleInstall(e, t) {
            ...
            if (!(await t.cachePut(e, s.clone()))) throw new n.V("bad-precaching-response", { url: e.url, status: s.status });
            return s;
          }
          _useDefaultCacheabilityPluginIfNeeded() {
            ...
            for (const [s, a] of this.plugins.entries())
              a !== u.copyRedirectedCacheableResponsesPlugin && (a === u.defaultPrecacheCacheabilityPlugin && (e = s), a.cacheWillUpdate && t++);
            0 === t ? this.plugins.push(u.defaultPrecacheCacheabilityPlugin) : t > 1 && null !== e && this.plugins.splice(e, 1);
          }
        }
        (u.defaultPrecacheCacheabilityPlugin = { cacheWillUpdate: async ({ response: e }) => (!e || e.status >= 400 ? null : e) }),
          (u.copyRedirectedCacheableResponsesPlugin = { cacheWillUpdate: async ({ response: e }) => (e.redirected ? await (0, h.S)(e) : e) });
        class d {
          constructor({ cacheName: e, plugins: t = [], fallbackToNetwork: s = !0 } = {}) {
            (this._urlsToCacheKeys = new Map()),
              (this._urlsToCacheModes = new Map()),
              (this._cacheKeysToIntegrities = new Map()),
              (this._strategy = new u({ cacheName: a.x.getPrecacheName(e), plugins: [...t, new o({ precacheController: this })], fallbackToNetwork: s })),
          ...
          addToCacheList(e) {
            ...
            for (const s of e) {
              ...
              if (this._urlsToCacheKeys.has(a) && this._urlsToCacheKeys.get(a) !== e)
                throw new n.V("add-to-cache-list-conflicting-entries", { firstEntry: this._urlsToCacheKeys.get(a), secondEntry: e });
              if ("string" != typeof s && s.integrity) {
                if (this._cacheKeysToIntegrities.has(e) && this._cacheKeysToIntegrities.get(e) !== s.integrity)
                  throw new n.V("add-to-cache-list-conflicting-integrities", { url: a });
            ...
            return (0, r.A)(e, async () => {
              ...
              for (const [t, s] of this._urlsToCacheKeys) {
                const a = this._cacheKeysToIntegrities.get(s),
                  ...
                  r = new Request(t, { integrity: a, cache: n, credentials: "same-origin" });
                await Promise.all(this.strategy.handleAll({ params: { cacheKey: s }, request: r, event: e }));
              }
          ...
          constructor(e, t) {
            super(({ request: s }) => {
              ...
              for (const n of (function* (
                e,
                { ignoreURLParametersMatching: t = [/^utm_/, /^fbclid$/], directoryIndex: s = "index.html", cleanURLs: a = !0, urlManipulation: n } = {}
              ) {
      ...
      362: (e, t, s) => {
        ...
        const c = { cacheWillUpdate: async ({ response: e }) => (200 === e.status || 0 === e.status ? e : null) };
        class o extends n._ {
          constructor(e = {}) {
          ...
          async _handle(e, t) {
            ...
            if (this._networkTimeoutSeconds) {
              const { id: a, promise: i } = this._getTimeoutPromise({ request: e, logs: s, handler: t });
              (r = a), n.push(i);
            }
            const i = this._getNetworkPromise({ timeoutId: r, request: e, logs: s, handler: t });
            n.push(i);
  ...
  (s.n = (e) => {
    ...
    (() => {
      var e = s(89),
        ...
        i = s(634);
      const c = JSON.parse(
          '["reblex\\\\.co\\\\.za(?:/.*)?/ola/services/.*","reblex\\\\.co\\\\.za/ola/meetings/.*","/api/","https://api\\\\.ola\\\\.godaddy\\\\.com","https://4a8daf6f-3318-43c5-b974-5992b0753d83\\\\.onlinestore\\\\.godaddy\\\\.com","/t/1/tl/event","google-analytics\\\\.com/collect","calendar\\\\.apps\\\\.(dev-|test-)?secureserver\\\\.net"]'
        ).map((e) => new RegExp(e)),
        o = JSON.parse(
          '["reblex\\\\.co\\\\.za(?:/.*)?/f/.*","https://blog\\\\.apps\\\\.secureserver\\\\.net/v1/website/4a8daf6f-3318-43c5-b974-5992b0753d83/feed/post/","https://blog\\\\.apps\\\\.secureserver\\\\.net/v1/website/4a8daf6f-3318-43c5-b974-5992b0753d83/feed"]'
        ).map((e) => new RegExp(e)),
        h = JSON.parse('["/blog","/podcast","/","/gallery","/about-us"]').map((e) => ({ url: e, revision: "1737547307749" }));
      self.addEventListener("activate", function (e) {
        e.waitUntil(
          caches.keys().then(function (e) {
            return Promise.all(e.filter((e) => e.startsWith("reblex.co.za-")).map((e) => caches.delete(e)));
          })
        );
      }),
        ...
        (0, e.registerRoute)(({ url: e }) => c.some((t) => t.test(e.href)), new t.NetworkOnly()),
        (0, r.precache)(h, { directoryIndex: null, cleanUrls: !1 }),
        (0, e.registerRoute)(
          ({ url: e }) => o.some((t) => t.test(e.href)),
          new t.NetworkFirst({ cacheName: "network-first", plugins: [new a.CacheableResponsePlugin({ statuses: [200] })] })
        ),
        (0, e.registerRoute)(
          ({ request: e }) => "style" === e.destination || "script" === e.destination,
          new t.StaleWhileRevalidate({ cacheName: "static-resources", plugins: [new a.CacheableResponsePlugin({ statuses: [200] })] })
        ),
        (0, e.registerRoute)(
        ...
        (0, e.registerRoute)(
          ...
          new t.CacheFirst({
            ...
            plugins: [new a.CacheableResponsePlugin({ statuses: [0, 200] }), new n.ExpirationPlugin({ maxAgeSeconds: 31536e3, maxEntries: 30 })],
          })
        ),
        (0, e.registerRoute)(
          ({ request: e }) => "image" === e.destination || "font" === e.destination,
          new t.CacheFirst({
            cacheName: "images-fonts",
            plugins: [new a.CacheableResponsePlugin({ statuses: [200] }), new n.ExpirationPlugin({ maxEntries: 100, maxAgeSeconds: 2592e3 })],
          })
        ),
        (0, i.clientsClaim)();
    })();
