!(function (t, e) {
  ...
  (() => {
    ...
    var t = {
      ...
      e = {};
    t.r(e), t.d(e, { _isDebug: () => v, debug: () => w, error: () => h, info: () => m, log: () => m, setDebug: () => b, warn: () => g });
    var n = {};
    t.r(n), t.d(n, { cmdLogEvent: () => Ki, cmdLogPerf: () => Gi });
    var r,
      o,
      i,
      a,
    ...
    var k = function (t, e) {
      ...
      C = function (t) {
        for (var e in t) void 0 === t[e] ? delete t[e] : "object" === E(t[e]) && (C(t[e]), 0 === Object.keys(t[e]).length && delete t[e]);
        return t;
      },
      I = function (t) {
      ...
      F = function () {
        return (function (t) {
          ...
          if (
            ((e += "-" + D(t.getUTCDate()) + "T" + D(t.getUTCHours()) + ":"), (e += D(t.getUTCMinutes()) + ":" + D(t.getUTCSeconds())), t.getUTCMilliseconds)
          ) {
    ...
    var W,
      ...
      et = function (t, e) {
        ...
        try {
          (W = f().performance) && W.timing
            ? ((function (t) {
                if ((t.merge(Y(W.timing)), W.getEntriesByName)) {
            ...
            : ("tcc" === t && n.set("tccperfapi", "not supported"), h("Error loading performance lib"));
        } catch (t) {
        ...
        setTimeout(function () {
          (f()._expDataLayer = f()._expDataLayer || []),
            f()._expDataLayer.push({
              ...
              data:
                "tcc" === t
                  ? { type: "pageperf", properties: T(e, $, { nav_type: "hard" }), custom_properties: n }
                  : { timing_object: T(e, $), is_hard_navigation: !0, custom_properties: n },
            });
        }, 0);
      },
      rt = function () {
    ...
    var ut,
      ...
      st = f().Request,
      lt = st && "keepalive" in new st(""),
      pt = void 0 !== l().sendBeacon,
      yt = function (t, e, n, r) {
      ...
      vt = function (t, e, n) {
        ...
        if (s && pt && !p.Authorization && "POST" === e)
          ...
          !(function (t, e, n, r, o) {
            var i = f().fetch;
            lt && i
              ? i(t, { keepalive: !0, method: e, headers: r, body: n, credentials: o }).catch(function (o) {
                  yt(t, e, n, r);
                })
              : yt(t, e, n, r);
          })(t, e, y, p, c);
      ...
      mt = function (t, e) {
        ...
        for (var n = t, r = 0; r < dt.length; r++) for (var o = dt[r].regex, i = n.match(o); i && i[0]; ) i = (n = n.replace(i[0], "REDACTED")).match(o);
        return n;
      },
      ht = function (t) {
        return (t = t || f().location.search) ? ("?" === t.substr(0, 1) && (t = t.substring(1)), t.split("&")) : [];
      },
      gt = function () {
        ...
        (e = [
          {
            ...
            value: function () {
              ...
              o ? (o("beforeunload", e, !1), o("pagehide", e, !1), o("pageshow", n, !1)) : r && (r("beforeunload", e), r("pagehide", e), r("pageshow", n));
              var i = s(),
              ...
              a &&
                a(
                  "visibilitychange",
                  function () {
                    "hidden" === i.visibilityState && t._hidePage(), "visible" === i.visibilityState && t._showPage();
                  }.bind(this)
                );
            },
          },
                ...
                try {
                  ...
                  Object.values(o).forEach(function (t) {
                    if (t.events.length > 10)
                      for (var e = t.events.length / 10, n = 0; n < e; n++) c.data.push(T(t, { events: t.events.slice(10 * n, 10 * n + 10) }));
                    else c.data.push(t);
                  }),
                    e._sendBatchCallback(c, { apiKey: a, isFlushing: e._isFlushing });
                } catch (t) {
          ...
          },
          {
            ...
            value: function (t, e, n) {
              ...
              return { batch: f[l] || { global: i, businessContext: c, events: [] }, batchKey: l, request: f };
            },
          },
          {
            key: "_processEvent",
            value: function (t, e, n) {
              ...
              return (
                ...
                n.events.length > this._maxEvents && this.pushEvent(T(n, { events: n.events.slice(this._maxEvents) })),
                (c[a] = i),
    ...
    var kt,
      ...
      Ct = function (t, e) {
        var n = e.apiKey,
          r = e.isFlushing;
        vt("".concat(gt("csp"), "/eventbus/web?clientid=").concat(n), "POST", Tt, { payload: t, sendAsBeacon: r });
      };
    function It(t) {
      return (
        (It =
    ...
    const qt = new ((function (t) {
      ...
      return (
        ...
        (r = [
          ...
          },
          {
            key: "set",
            value: function (t, n) {
              Dt(e, "set", this, 3)([t, n]), this._updateWindow();
            },
          },
          {
            key: "merge",
            value: function (t) {
              Dt(e, "merge", this, 3)([t]), this._updateWindow();
            },
          },
        ]) && xt(n.prototype, r),
      ...
      build: { env: "prod", date: "2024-12-22T23:44:05.033Z" },
      client: { name: "scc-c2", version: "1.0.1" },
      cookie: { sameSite: "none" },
      site: { privateLabelId: "" },
      sGtm: { enabled: A(""), whitelist: Ft(""), account: "", host: "" },
      ga: { account: "" },
      wGtm: { account: "", enableProxy: A(""), enabled: A(""), requireGoogleClientId: A(""), whitelist: Ft("") },
      eventBus: { enabled: A("true"), sccApiKey: "b18ef4f046435b64a469b32c3c1c20a3", rigorApiKey: "8da2217409854bee82e12dc4ca0b39fb" },
        ...
        var t,
          ...
          n = (function () {
            for (var t = {}, e = 0; e < Nt.length; e++) {
              var n = Nt[e];
              k(n, function (e, n) {
                -1 === Wt.indexOf(e.toLowerCase()) && (Xt(e, n), Zt(e) || (t[e] = n));
              });
            }
            return t;
          })();
        (e = {
          identity: { realm: (t = n)["".concat(Ut, ".realm")] },
          site: { privateLabelId: t["".concat(Ut, ".privateLabelId")] },
          timing: { auto: !A(t["".concat(Ut, ".manualPagePerf")], !1) },
          page: {
            spa: t["".concat(Ut, ".spa")],
          ...
          cookie: { sameSite: t["".concat(Ut, ".cookies.sameSite")] },
          wGtm: { enabled: A(t["".concat(Ut, ".webGtmEnabled")], !1) },
          clickListener: { enabled: !A(t["".concat(Ut, ".listenerDisabled")], !1), navDelayMs: t["".concat(Ut, ".eventDelayMs")] },
        }),
    ...
    const te = { randomUUID: "undefined" != typeof crypto && crypto.randomUUID && crypto.randomUUID.bind(crypto) };
    let ee;
    const ne = new Uint8Array(16);
    function re() {
      if (!ee && ((ee = "undefined" != typeof crypto && crypto.getRandomValues && crypto.getRandomValues.bind(crypto)), !ee))
    ...
    const ie = function (t, e, n) {
      if (te.randomUUID && !e && !t) return te.randomUUID();
    ...
    var he = (function () {
        return de(
          function t(e, n) {
            if ((ve(this, t), !e)) throw "Missing version definitions";
      ...
      ge = (function () {
        return de(
          function t(e) {
            if ((ve(this, t), !e)) throw "Missing type definitions";
    ...
    function Be(t, e, n) {
      return e && Me(t.prototype, e), n && Me(t, n), Object.defineProperty(t, "prototype", { writable: !1 }), t;
    }
    function Fe(t) {
      var e = (function (t) {
    ...
    var Ue = function (t, e, n) {
        ...
        if ("undefined" !== i) {
          ...
          if ("function" === i || a) for (var c = a ? e.transformFn : [e.transformFn], u = 0; u < c.length; u++) r = c[u](r, n);
          else r = e.transformFn;
        }
        return e._outputType && e._outputType === je && (r = r.toString()), r;
      },
      Ne = (function () {
        return Be(
          function t(e) {
          ...
          [
            {
              key: "parse",
              value: function (t) {
                if ((this.validate(t), this._fieldType !== Pe || t || "boolean" == typeof t || 0 === t)) {
            ...
            },
            {
              key: "validate",
              value: function (t) {
                if (this._fieldType === Ee && !t && "boolean" != typeof t && 0 !== t) throw "Missing required property '".concat(this.name, "'");
            ...
            },
            {
              key: "optional",
              value: function () {
                return (this._fieldType = Pe), this;
              },
            },
            {
              key: "required",
              value: function () {
                return (this._fieldType = Ee), this;
              },
            },
            {
              key: "stringify",
      ...
      Ve = (function (t) {
        function e(t, n) {
          var r;
          return Ae(this, e), ((r = Te(this, e, [t])).definitionType = "Schema"), (r.properties = n), r;
        }
        return (
          Re(e, t),
          Be(e, [
      ...
      Ke = (function (t) {
        function e() {
          return Ae(this, e), Te(this, e, arguments);
        }
        return (
          Re(e, t),
          Be(e, [
          ...
          Be(e, [
            ...
            },
            {
              ...
              value: function (t) {
                ...
                var n = qe(t);
                if ("string" === n) {
                  if (this._pattern && !t.match(this._pattern)) throw "Input ".concat(t, " does not match ").concat(this._pattern);
      ...
      ze = (function (t) {
        function e() {
          var t;
          return Ae(this, e), ((t = Te(this, e)).definitionType = "Object"), t;
        }
        return (
          Re(e, t),
          Be(e, [
            {
              ...
              value: function () {
                if (this._resolutionType === ke) {
                  var t = {};
                  return (t["".concat(this.name, " (").concat(this._fieldType, ")")] = Ie(e, "stringify", this, 3)([])), t;
                }
            ...
            },
            {
              key: "substitute",
              value: function (t) {
                return (this.properties = this.properties.concat(t)), (this._resolutionType = "sub"), this;
              },
            },
            {
              key: "map",
              value: function (t, e) {
                return (this.name = t), (this.properties = this.properties.concat(e)), (this._resolutionType = ke), this;
              },
            },
            {
              key: "extend",
      ...
      He = (function (t) {
        function e() {
          var t;
          return Ae(this, e), ((t = Te(this, e)).definitionType = "Collection"), (t.minElements = 0), t;
        }
        return (
          Re(e, t),
          Be(e, [
            ...
            },
            {
              key: "withMinElements",
              value: function (t) {
                return (this.minElements = t), (this._fieldType = t > 0 ? Ee : Pe), this;
              },
            },
          ])
        );
    ...
    function Je(t, e) {
      for (var n = 0; n < e.length; n++) {
        var r = e[n];
        (r.enumerable = r.enumerable || !1), (r.configurable = !0), "value" in r && (r.writable = !0), Object.defineProperty(t, Ze(r.key), r);
      }
    }
    function Ze(t) {
      var e = (function (t) {
                  ...
                  this.beforeEvent && this.beforeEvent(),
                    (function () {
                      for (; Jt < Nt.length; ) {
                        var t = Nt[Jt];
                        k(t, function (t, e) {
                          -1 === Wt.indexOf(t.toLowerCase()) && Zt(t) && (Xt(t, e), (Qt[t] = e));
                        }),
                          Jt++;
                      }
                    })(),
          ...
          (r = [
            {
              ...
              value: function (t) {
                ...
                ((n = e),
                (r = this),
                "function" == typeof (o = ln(pn(1 & 3 ? n.prototype : n), "pushLog", r))
                  ? function (t) {
                      return o.apply(r, t);
                    }
                  : o)([t]);
    ...
    var mn,
      ...
      wn = function (t, e, n, r) {
        ...
        i.setTime(i.getTime() + 60 * n * 1e3),
          (s().cookie =
            "".concat(t, "=").concat(encodeURI(e), "; domain=").concat(y(), "; ") +
      ...
      _n = function () {
        var t,
          e = s().querySelector("meta[name='gd:traceId']");
        return e && (t = e.getAttribute("content")), t && !qt.get("tcc.disablePageTracing") ? { trace_id: t, traced: 1 } : { trace_id: ae().replace(/-/g, "") };
      },
      Sn = "experiments";
    const Pn = new H();
    function En(t) {
            ...
            value: function () {
              ...
              if (this._contextFnMap) {
                ...
                Object.entries(this._paramsFnMap).forEach(function (t) {
                  ...
                  e &&
                    (this.version++, (this.context = R(this._buildContext(n))), (this._contextMap = n), this._windowName && j(this._windowName, this.context));
              }
            },
          },
        ]) && Ln(t.prototype, e),
    ...
    var Mn = { "godaddy.com": 1, "mediatemple.net": 4500, "afternic.com": 497036 },
      Bn = [
        function () {
        ...
        function () {
          ...
          if (Mn.hasOwnProperty(t)) return Mn[t];
        },
      ],
      Fn = function () {
    ...
    const $n = new ((function (t) {
        ...
        (r = [
          {
            ...
            value: function (t) {
              ...
              ((n = e),
              (r = this),
              "function" == typeof (o = Kn(Gn(1 & 3 ? n.prototype : n), "init", r))
                ? function (t) {
                    return o.apply(r, t);
                  }
                : o)([{ context: { traceId: i }, contextFnMap: a, paramsFnMap: c }]);
            },
          },
        ]),
        r && Un(n.prototype, r),
      ...
      var n, r;
    })(Dn))({ contextFnMap: Hn, paramsFnMap: Wn, windowName: "globalContext" });
    var Qn = ["events"];
    function Jn(t, e) {
      (null == e || e > t.length) && (e = t.length);
      for (var n = 0, r = Array(e); n < e; n++) r[n] = t[n];
      ...
      tr = function (t, e, n) {
        ...
        e.batch
          ? ((o.events = r
              ...
              : n.events),
            o.events.length > 0 && Yn(t, e, o))
          : n.events.forEach(function (n) {
              (r && !r.includes(n.schemaId)) || Yn(t, e, T(o, { event: n }));
            });
      },
      er = function (t, e) {
        var n = or();
          ...
          },
          {
            ...
            value: function (t) {
              if (!this.internal.hasFired) {
                ...
                if (e && 0 !== e.length) {
                  for (var n = F(), r = 0; r < e.length; r++) e[r].data = T({ eventCreationTimestamp: n }, e[r].data);
    ...
    var _r = "urn:shared:user:event:/data-platform/signals/click/v1",
      ...
      qr = function () {
        var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
          ...
          r = t.eventCategory;
        return T(
          { pageLevelProperties: T(Qt), identityRealm: Kt("identity", "realm") },
          e && { eid: e },
      ...
      Ur = function (t, e, n, r) {
        var o = { traffic: qr({ eid: e, customProperties: r }), producerEventId: t };
        if (e) {
          var i = (function (t) {
              return t.split(".");
            })(e),
      ...
      Vr = function (t, e, n, r) {
        ...
        var i = { navigationType: e.navigationType, timing: { navigation: o }, traffic: qr({ customProperties: n }), producerEventId: t, contentLoadType: r };
        return (
          "hard" === r &&
            ((i.response = tt(e)),
            (i.timing.marks = e.marks),
            (i.timing.measures = e.measures),
            (i.timing.paint = { firstPaint: e.fp, firstContentfulPaint: e.fcp, largestContentfulPaint: e.lcp })),
          i
        );
      },
      Kr = function (t, e, n) {
        return {
          timing: {
            ...
            vitals: { cumulativeLayoutShift: e.CLS, firstInputDelay: e.FID, timeToInteractive: e.timeToInteractive, interactionToNextPaint: e.INP },
          },
          traffic: qr({ customProperties: n }),
          producerEventId: t,
        };
      };
    function Gr(t) {
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              return (
                ...
                [{ schemaId: this._getSchemaId(), data: T(t, { producerEventId: e || this.internal.eventId, element: t.element, traffic: qr(n) }) }]
              );
            },
          },
          {
            ...
            value: function (t, e) {
              return arguments.length > 2 && void 0 !== arguments[2]
                ? arguments[2]
                : "".concat(e.area, ".").concat(e.product, ".").concat(e.section, ".").concat(e.widget, ".").concat(t);
            },
          },
          {
    ...
    function ao(t, e) {
      for (var n = 0; n < e.length; n++) {
        var r = e[n];
        (r.enumerable = r.enumerable || !1), (r.configurable = !0), "value" in r && (r.writable = !0), Object.defineProperty(t, co(r.key), r);
      }
    }
    function co(t) {
      var e = (function (t) {
                ...
                t.impressions.forEach(function (t) {
                  ...
                  r.push.apply(
                    ...
                    (function (t) {
                      ...
                      ((o = e),
                      (i = n),
                      "function" == typeof (a = fo(so(1 & 3 ? o.prototype : o), "_getEvents", i))
                        ? function (t) {
                            return a.apply(i, t);
                          }
                        : a)([t, ae()])
    ...
    function vo(t, e) {
      for (var n = 0; n < e.length; n++) {
        var r = e[n];
        (r.enumerable = r.enumerable || !1), (r.configurable = !0), "value" in r && (r.writable = !0), Object.defineProperty(t, bo(r.key), r);
      }
    }
    function bo(t) {
      var e = (function (t) {
        ...
        (r = [
          {
            key: "process",
            value: function (t) {
              er(t.name, { callback: t.callback, schemaIds: t.schemaIds, batch: t.batch, fields: t.fields });
            },
          },
        ]) && jo(n.prototype, r),
        Object.defineProperty(n, "prototype", { writable: !1 }),
        ...
        return (
          ...
          (r = [
            ...
            },
            {
              key: "set",
              value: function (t, n) {
                "object" !== To(n) && "[object Function]" !== {}.toString.call(n)
                  ? Lo(e, "set", this, 3)([t, n])
                  : h(
    ...
    function zo(t, e) {
      for (var n = 0; n < e.length; n++) {
        var r = e[n];
        (r.enumerable = r.enumerable || !1), (r.configurable = !0), "value" in r && (r.writable = !0), Object.defineProperty(t, Ho(r.key), r);
      }
    }
    function Ho(t) {
      var e = (function (t) {
    ...
    var Jo = 0,
                ...
                return [
                  {
                    schemaId: kr,
                    data: {
                      forensics: { traceIdAdopted: A(dn.get("traced")), components: Zo() },
                      traffic: qr({ customProperties: e.getProperties() }),
            ...
            },
            {
              ...
              value: function (t) {
                var e = t.path || t.virtual_path || t.virtualPath,
                  n = void 0 !== e;
                if ((n || (e = f().location.pathname), Mo === e)) throw "cmd: LogPageRequest duplicate page request detected, ignoring duplicate path";
                (Mo = e),
                  dn.set("corrid", Ko()),
                  n && (Yt(), dn.set("virtual_path", e)),
      ...
      Yo = function (t) {
        return [
          new ze()
            .map("element", [
              new Ge("area").required().pattern(_e),
              new Ge("product").required().pattern(_e),
              new Ge("section").required().pattern(Se),
              new Ge("widget").required().pattern(_e),
            ])
            .required()
            .extend(t),
        ];
      ...
      ni = function () {
        return [
          new ze().substitute(Yo()),
          new ze().substitute(ei()),
          new ze().map("promotion", [new Ke("id").required(), new Ke("name"), new Ke("creative"), new Ke("position")]),
          new ze().map("product", [
            new Ke("actionCode").required().allowedValues(["add_to_cart", "product_detail"]),
            new ze().map("basket", [new Ke("couponCode"), new Ke("currencyCode"), new Ke("itemTrackingCode")]),
            new He().map("products", [
              new Ke("productId").required(),
              new Ke("productName"),
              new Ke("productInstanceId"),
              new Ke("priceUsd"),
              new Ke("quantity").required(),
              new Ke("couponCode"),
              new Ke("itemTrackingCode"),
            ]),
            new He().map("packages", [new Ke("id"), new Ke("priceUsd"), new Ke("quantity"), new Ke("category")]),
          ]),
        ];
      };
    const ri = {
      add_click: { v1: { handler: ro, properties: [new ze().substitute(ni()).transform(Vo)] } },
      add_element_action: {
        v1: {
          handler: Jr,
          properties: [
            new ze()
              .substitute([
                new ze().substitute(Yo([new Ke("action").required().allowedValues(["blur", "drag", "focus", "hover", "load", "scroll"])])),
                new ze().substitute(ei()),
              ])
              .transform(Vo),
          ],
      ...
      add_impressions: { v1: { handler: po, properties: [new He().map("impressions", [new ze().substitute(ni()).transform(Vo)]).withMinElements(1)] } },
      add_virtual_page_view: { v1: { handler: Xo, properties: [new Ke("virtualPath").required(), new ze().substitute(ti())] } },
      add_micro_events: {
        v1: {
          handler: jr,
          properties: [
            new Ke("apiKey").required(),
            new Ke("schemaId").required(),
            new He().map("events", [new Ke("schemaId").required(), new Ke("data").required()]).withMinElements(1),
            new ze().map("businessContext", [new Ke("schemaId").required(), new Ke("data").required()]),
          ],
        },
      },
      subscribe: {
        v1: { handler: ko, properties: [new Ke("name").required(), new Ke("callback").required(), new Ke("schemaIds"), new Ke("fields"), new Ke("batch")] },
      },
      set_config: {
        v1: {
          handler: wo,
          properties: [
            new ze()
              .map("config", [
                new He().map("components", [new Ke("name").required(), new Ke("version").required().outputType(je)]),
                new ze().map("cookie", [new Ke("sameSite")]),
                new ze().map("page", [new Ke("spa"), new Ke("id"), new Ke("contentGroup"), new Ke("referrerExclusion")]),
                new ze().map("identity", [new Ke("realm")]),
                new ze().map("site", [new Ke("privateLabelId")]),
                new ze().map("timing", [new Ke("auto")]),
              ])
              .required(),
            new Ke("overwrite"),
          ],
    ...
    er("scc-experiment-listener", {
      callback: function (t) {
        var e = t.event,
          n = e.data;
        if (e.schemaId === Lr) ui(n.experimentId, n.variantId);
      ...
      vi = function (t) {
        ...
        if (!yi) {
          (yi = !0),
            ...
            dn.merge(_n()),
            $n.init(li({ traceId: dn.get("trace_id") }, o)),
            Oe(ri),
            (function () {
              var t = f();
          ...
          mn.getSession(), c && c();
          var y = new an(li({ autoPageViewDisabled: qt.get("".concat(n, ".manualPageRequest")), beforeEvent: u }, r));
                ...
                f()._signalsDataLayer.push({
                  ...
                  data: {
                    ...
                    callback: function (t) {
                      ...
                      kt.pushEvent({ apiKey: a, businessContext: r, contextVersion: u, schemaId: e, global: n, events: o }, c);
                    },
                  },
                }));
          }),
    ...
    function gi(t, e) {
      for (var n = 0; n < e.length; n++) {
        var r = e[n];
        (r.enumerable = r.enumerable || !1), (r.configurable = !0), "value" in r && (r.writable = !0), Object.defineProperty(t, _i(r.key), r);
      }
    }
    function wi() {
      try {
      ...
      Ei = (function (t) {
        function e() {
          ...
          return (
            ...
            (n = t),
            (o = "_scc_session"),
            (r = _i((r = "_sessionCookieName"))) in n ? Object.defineProperty(n, r, { value: o, enumerable: !0, configurable: !0, writable: !0 }) : (n[r] = o),
            t
          );
        }
        return (
          ...
          (r = [
            {
              ...
              value: function () {
                var t = On(Si),
                  e = On(Pi);
                t || e ? (t || (t = ae()), e || (e = ae())) : (t = e = ae()), wn(Si, t, 525600, "/"), wn(Pi, e, 30, "/");
                var n = jn(this._sessionCookieName);
                return { visitorGuid: t, visitGuid: e, pageCount: M(n.pc) || 0 };
              },
            },
          ]) && gi(n.prototype, r),
          Object.defineProperty(n, "prototype", { writable: !1 }),
              ...
              },
              {
                ...
                value: function () {
                  var t = jn(this._sessionCookieName),
                    e = M(t.pc) || 0;
                  (t.pc = e + 1), (t.C_TOUCH = F()), this.saveSessionCookie(t);
                },
              },
            ]) && di(t.prototype, e),
            Object.defineProperty(t, "prototype", { writable: !1 }),
              ...
              return [
                {
                  ...
                  data:
                    r !== Er
                      ? Ur(this.internal.eventId, e, n, o)
                      : { traffic: qr({ customProperties: o, eid: e, eventCategory: n }), producerEventId: this.internal.eventId },
                },
              ];
            },
          },
            ...
            },
            {
              ...
              value: function (t) {
                var e = t.is_hard_navigation ? "hard" : "soft",
                  n = t.timing_object;
                if (n) {
                  if (n.navigationStart) return [{ schemaId: Rr, data: Vr(this.internal.eventId, n, t.custom_properties, e) }];
                  if (n.timeToInteractive) return [{ schemaId: Dr, data: Kr(this.internal.eventId, n, t.custom_properties) }];
                }
              },
            },
          ]) && Ai(n.prototype, r),
    ...
    const Vi = {
        add_event: { v1: { handler: Ri, properties: [new Ke("type").required(), new ze().substitute([new Ke("eid").optional()]), new ze().substitute(Ni())] } },
        add_page_view: { v1: { handler: Xo, properties: [new Ke("path").optional(), new ze().substitute(Ni())] } },
        add_perf: { v1: { handler: Ui, properties: [new Ke("timing_object").required(), new Ke("is_hard_navigation").optional(), new ze().substitute(Ni())] } },
      },
      Ki = function (t, e, n) {
        f()._expDataLayer.push({ schema: "add_event", version: "v1", data: { type: t, eid: e, custom_properties: Fo(n) } });
      },
      Gi = function (t, e) {
        f()._expDataLayer.push({ schema: "add_perf", version: "v1", data: { timing_object: t, custom_properties: Fo(e) } });
      };
        ...
        switch (t.schemaId) {
          case xr:
            return (function (t, e, n) {
              ...
              null === (n = t.data.payment) || void 0 === n ? void 0 : n.pendingFlag,
              t.data.order
            );
          case Tr:
    ...
    return (
      ...
      (function (t) {
        ...
        !(function () {
          try {
            ...
            Object.defineProperty(document, "cookie", {
              ...
              set: function (t) {
                (o = o || Object.getOwnPropertyDescriptor(Document.prototype, "cookie")).set.call(document, t), (i = o.get.call(document));
              },
              configurable: !0,
              enumerable: !0,
            }),
              (function () {
                if (((a = l().userAgent.toLowerCase()), !/msie [1-8]\./.test(a)))
                  if (((i = "_".concat(e, "Internal")), (c = i), void 0 !== f()[c] || ((f()[c] = {}), 0))) h("SCC Library has already been loaded on page");
                  else if (
                    ((function (t) {
                      var e = t.dataLayerName,
                        ...
                        o = t.legacyName;
                      (Ut = o), (Wt = r || []), (Vt = e), (Ht = n), (Nt = f()[Vt] || []), _(Vt, Nt), j("".concat(Vt, "Log"), $t), Yt();
                    })(n),
                    r && r(),
        ...
        legacyName: ua,
        trfqMethods: n,
        configManagerProps: { legacyName: ua, dataLayerName: "_trfd", clientConfigPrefixes: [ua] },
        dataLayerConfig: { pageViewSchema: "add_page_view", autoPageViewDisabled: !1, immediateSchemas: ["add_page_view"] },
        globalContextConfig: {
          contextFnMap: {
        ...
        hooks: {
          ...
          onLoad: function () {
            j(ra, []),
              ...
              f()._signalsDataLayer.push({
                schema: "subscribe",
                data: { name: "scc-plugin-sink-event-service", batch: !0, callback: ia, schemaIds: oa, fields: ["webContext"] },
              });
          },
          beforeLoad: function () {
            An.init({ contextFnMap: ca });
          },
        },
      }),
      {}
